export const FINISH = {
  ...
  McDonalds:   { label: "Mc Donald's", color: "#fcc424", dimColor: "rgba(252,196,36,0.55)",  bg: "rgba(252,196,36,0.10)",  border: "rgba(252,196,36,0.45)", glow: "rgba(252,196,36,0.28)"  },
};
...
export function rarToFinish(r) {
  ...
  if (r === "McDonalds" || r === "Mc Donald's")                                   return "McDonalds";
  return "Comum";
}
